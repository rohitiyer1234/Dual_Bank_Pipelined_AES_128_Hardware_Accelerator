...
The design sustains one 128-bit block per clock cycle after pipeline fill while supporting concurrent key expansion and non-blocking key rotation.
...
| Registers | 5,980 |
| BRAM | 1 |
| Timing Closure | +3.91 ns WNS @ 100 MHz |
| Verification | 12,562 datapath vectors + 49 key-system tests |
| Functional Failures | 0 |
  
## Table of Contents

- [Synthesis Results — Xilinx Zynq-7000](#synthesis-results---xilinx-zynq-7000);
...
Designed, implemented, synthesized, and verified the accelerator end-to-end as an independent RTL project.
...
- FPGA bring-up and on-board validation on PYNQ-Z2
- DMA-based PS/PL integration
